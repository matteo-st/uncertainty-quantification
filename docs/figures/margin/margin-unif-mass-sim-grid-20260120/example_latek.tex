...
\subsection{Impact of the Number of Bins (Margin Score)}
\label{sec:ablation_bins_margin}

Figure~\ref{fig:ablation_bins_margin} shows how the number of bins $K$ affects the performance of the certified detector (CD) when applied to the Margin score.
...
The red horizontal line represents the uncertified Margin score baseline, with the shaded region indicating $\pm 1$ standard deviation across 9 random splits.

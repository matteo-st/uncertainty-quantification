...
# CIFAR-10 ResNet-34
echo "Running uniform_mass on CIFAR-10 ResNet-34..."
python -m error_estimation.experiments.run_detection \
  ...
  --config-detection configs/postprocessors/uniform_mass/cifar10_resnet34/uniform-mass-cal-fit-doctor.yml \
  --mode search \
  --run-tag "${RUN_TAG}" \
...
echo "Running uniform_mass on CIFAR-10 DenseNet-121..."
python -m error_estimation.experiments.run_detection \
  --config-dataset configs/datasets/cifar10/cifar10_n_res-1000_n-cal-4000.yml \
  --config-model configs/models/cifar10_densenet121.yml \
  --config-detection configs/postprocessors/uniform_mass/cifar10_densenet121/uniform-mass-cal-fit-doctor.yml \
  --mode search \
  --run-tag "${RUN_TAG}" \
  --seed-splits 1 2 3 4 5 6 7 8 9 \
  --data-dir "${DATA_DIR}" \
...
# CIFAR-100 ResNet-34
echo "Running uniform_mass on CIFAR-100 ResNet-34..."
python -m error_estimation.experiments.run_detection \
  ...
  --config-detection configs/postprocessors/uniform_mass/cifar100_resnet34/uniform-mass-cal-fit-doctor.yml \
  --mode search \
  --run-tag "${RUN_TAG}" \
  --seed-splits 1 2 3 4 5 6 7 8 9 \
  --data-dir "${DATA_DIR}" \
...
echo "Running uniform_mass on CIFAR-100 DenseNet-121..."
python -m error_estimation.experiments.run_detection \
  --config-dataset configs/datasets/cifar100/cifar100_n_res-1000_n-cal-4000.yml \
  --config-model configs/models/cifar100_densenet121.yml \
  --config-detection configs/postprocessors/uniform_mass/cifar100_densenet121/uniform-mass-cal-fit-doctor.yml \
  --mode search \
  --run-tag "${RUN_TAG}" \
  --seed-splits 1 2 3 4 5 6 7 8 9 \
  --data-dir "${DATA_DIR}" \

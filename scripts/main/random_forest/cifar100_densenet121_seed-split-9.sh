...
python -m error_estimation.experiments.run_detection \
    ...
    --config_detection configs/postprocessors/random_forest/cifar100_densenet121_hyperparams_search.yml \
    --root_dir ./results_main/random_forest/cifar100_densenet121/ \
    --seed 1 \
    --gpu_id 0 \

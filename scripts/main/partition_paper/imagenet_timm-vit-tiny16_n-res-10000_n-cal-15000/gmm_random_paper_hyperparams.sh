...
python -m error_estimation.experiments.run_detection \
    ...
    --config_detection configs/postprocessors/clustering/imagenet_timm-vit-tiny16/gmm_random_paper.yml \
    --root_dir ./results_main/partition_gmm_paper/imagenet_timm-vit-tiny16/n_res-10000_n_cal-15000/calibrate_paper_hyperparams_random \
    --seed 1 \
    --gpu_id 1 \

...
python -m error_estimation.experiments.run_detection \
    ...
    --config_detection configs/postprocessors/clustering/cifar100_densenet121/gmm_kmeans_paper.yml \
    --root_dir ./results_main/partition_gmm_paper/cifar100_densenet121/n_res-3000_n_cal-2000/procedure-1_paper_hyperparams_kmeans \
    --seed 1 \
    --gpu_id 0 \

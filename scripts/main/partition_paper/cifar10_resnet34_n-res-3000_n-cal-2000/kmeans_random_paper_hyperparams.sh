...
python -m error_estimation.experiments.run_detection \
    ...
    --config_detection configs/postprocessors/clustering/cifar10_resnet34/kmeans_random_paper.yml \
    --root_dir ./results_main/partition_kmeans_paper/cifar10_resnet34/n_res-3000_n_cal-2000/procedure-1_paper_hyperparams_random \
    --seed 1 \
    --gpu_id 0 \
